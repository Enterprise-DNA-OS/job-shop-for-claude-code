...
<!-- TODO(author): how to bring data across from Ostendo; link docs/replace-ostendo.md -->
...
Enterprise DNA installs Job Shop for Claude Code for your business, migrates your Ostendo data, connects it to the rest of your tools, and runs it for you as part of **Omni**, our managed Command Center. One setup fee, then a monthly retainer.
